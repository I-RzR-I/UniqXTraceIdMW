...
set applicationName=RzR.Web.Middleware.TraceId
...
set solutionPath=$('..\src\RzR.MiddleWares.sln')
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\UniqXTraceIdMW\UniqXTraceIdMW.csproj')
set testProjectsPath=$('..\src\tests\UniqXTraceIdMW.Tests\UniqXTraceIdMW.Tests.csproj')
